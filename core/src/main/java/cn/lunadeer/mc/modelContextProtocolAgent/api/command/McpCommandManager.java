...
public class McpCommandManager {
    ...
    public McpCommandManager(ModelContextProtocolAgent plugin) {
        this.plugin = plugin;
        registerCommands();
    }
    ...
    private void registerCommands() {
        ...
        commands.put("server", new McpServerCommand(plugin));
    ...
    private void sendHelp(CommandSender sender) {
        ...
        sender.sendMessage("§7/mcp server <start|stop> §f- Control WebSocket server");
    }
}
