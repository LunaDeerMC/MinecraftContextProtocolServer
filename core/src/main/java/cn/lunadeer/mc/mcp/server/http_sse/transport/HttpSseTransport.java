package cn.lunadeer.mc.mcp.server.http_sse.transport;

import cn.lunadeer.mc.mcp.core.registry.CapabilityRegistry;
import cn.lunadeer.mc.mcp.server.http_sse.handler.InitializeHandler;
import cn.lunadeer.mc.mcp.server.http_sse.handler.InitializedHandler;
import cn.lunadeer.mc.mcp.server.http_sse.handler.ToolsHandler;
import cn.lunadeer.mc.mcp.server.http_sse.lifecycle.SessionManager;
import cn.lunadeer.mc.mcp.server.http_sse.message.JsonRpcMessage;
import cn.lunadeer.mc.mcp.server.http_sse.message.JsonRpcNotification;
...
public class HttpSseTransport {
    ...
    public HttpSseTransport(
        ...
        this.initializeHandler = new InitializeHandler(sessionManager, serverId, serverName, serverVersion);
