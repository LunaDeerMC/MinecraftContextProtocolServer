package cn.lunadeer.mc.mcp.server.websocket_gateway;
...
import cn.lunadeer.mc.mcp.server.websocket_gateway.handler.AuthMessageHandler;
import cn.lunadeer.mc.mcp.server.websocket_gateway.handler.HeartbeatAckMessageHandler;
import cn.lunadeer.mc.mcp.server.websocket_gateway.handler.RequestMessageHandler;
...
import cn.lunadeer.mc.mcp.server.websocket_gateway.session.WebSocketConnection;
...
/**
 * WebSocket server for MCP Server using Java-WebSocket library.
...
public class WebSocketServer {
    ...
    public static class WebSocketServerText extends ConfigurationPart {
        public String wsServerStarted = "MCP Server WebSocket server for gateway started on {0}:{1}";
    ...
    public WebSocketServer(String host, int port, ExecutionEngine executionEngine) {
        this.host = host;
        this.port = port;
    ...
    public CompletableFuture<Void> start() {
        return CompletableFuture.runAsync(() -> {
            try {
                ...
                XLogger.info(I18n.webSocketServerText.wsServerStarted, host, port);
            } catch (Exception e) {
                XLogger.error(I18n.webSocketServerText.wsServerFailed, e.getMessage());
    ...
    public void stop() {
        if (webSocketServer != null) {
            ...
            XLogger.info("MCP Server WebSocket server stopped");
        }
    }
    ...
    public void broadcast(McpMessage message) {
        ...
        for (GatewaySession session : sessionManager.getAuthenticatedSessions()) {
            session.send(json).exceptionally(ex -> {
                XLogger.warn(I18n.webSocketServerText.wsBroadcastFailed,
     ...
     */
    private class WebSocketServerImpl extends org.java_websocket.server.WebSocketServer {
        ...
        public void onOpen(WebSocket webSocket, ClientHandshake handshake) {
            ...
            XLogger.debug(I18n.webSocketServerText.wsClientConnected,
        ...
        public void onClose(WebSocket webSocket, int code, String reason, boolean remote) {
            ...
            XLogger.debug(I18n.webSocketServerText.wsClientDisconnected,
        ...
        public void onError(WebSocket webSocket, Exception ex) {
            XLogger.error(I18n.webSocketServerText.wsConnectionError,
        ...
        private void handleMessage(GatewaySession session, String json) {
            try {
                ...
                XLogger.error(I18n.webSocketServerText.wsMessageHandlingError,
