package cn.lunadeer.mc.mcp.server.http_sse.handler;

import cn.lunadeer.mc.mcp.server.http_sse.lifecycle.SessionInfo;
import cn.lunadeer.mc.mcp.server.http_sse.lifecycle.SessionManager;
import cn.lunadeer.mc.mcp.server.http_sse.lifecycle.SessionState;
import cn.lunadeer.mc.mcp.server.http_sse.message.JsonRpcRequest;
import cn.lunadeer.mc.mcp.server.http_sse.message.JsonRpcResponse;
...
public class InitializeHandler {
    ...
    public InitializeHandler(SessionManager sessionManager, String serverId, String serverName, String serverVersion) {
    ...
    public JsonRpcResponse handle(JsonRpcRequest request, String sessionId) {
        ...
        result.addProperty("instructions", "MCP Server ready. Use initialized notification to complete initialization.");
    ...
    private Map<String, Object> buildServerInfo() {
        ...
        serverInfo.put("title", serverName);
        serverInfo.put("version", serverVersion);
        serverInfo.put("description", "Minecraft MCP Server - Provides Minecraft server capabilities via MCP protocol");
