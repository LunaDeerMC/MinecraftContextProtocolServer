package cn.lunadeer.mc.mcp.server.websocket_gateway.heartbeat;

import cn.lunadeer.mc.mcp.Configuration;
import cn.lunadeer.mc.mcp.server.websocket_gateway.codec.MessageCodec;
import cn.lunadeer.mc.mcp.server.websocket_gateway.message.ServerStatus;
import cn.lunadeer.mc.mcp.server.websocket_gateway.message.HeartbeatAck;
import cn.lunadeer.mc.mcp.server.websocket_gateway.message.HeartbeatMessage;
...
import static cn.lunadeer.mc.mcp.infrastructure.Misc.isPaper;
...
public class HeartbeatHandler {
    ...
    /**
     * Builds the server status for heartbeat messages.
     *
